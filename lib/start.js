        ...
        var cmdQueue = async.priorityQueue(function(cmdInfo, next) {
            ...
            arrTasks.push(function(callback){
                ...
                if(window !== lastWindowId){
                    ...
                    checkerBrowser && checkerBrowser.switchWindow(window).then(doNext).catch(catchError) || doNext();
                }
                else{
                    callback();
                }
            ...
            arrTasks.push(function(callback){
                ...
                if(mobile){
                    ...
                    switch(cmd){
                        case 'url':
                            pushTestCode('url', '', data, 'return driver.url(_(\''+eacapeStr(data)+'\'));');
                        ...
                        case 'uploadFile':
                            ...
                            checkerBrowser && checkerBrowser.sleep(300).wait(data.path, {timeout: 10000})
                                .sleep(300).sendKeys(rootPath+'/uploadfiles/'+data.filename).then(doNext).catch(catchError) || doNext();
                            break;
                        // 添加断言
                        case 'expect':
                            co(function*(){
                                ...
                                if(reDomRequire.test(expectType)){
                                    arrCodes.push('return driver.sleep('+sleepTime+').wait(\''+eacapeStr(expectParams[0])+'\', 30000)');
                                }
                                else{
                                ...
                                switch(expectCompare){
                                    case 'equal':
                                        arrCodes.push('       .should.equal(_('+(/^(true|false)$/.test(codeExpectTo)?codeExpectTo:'\''+eacapeStr(codeExpectTo)+'\'')+'));');
                                        break;
                                    case 'notEqual':
                                        arrCodes.push('       .should.not.equal(_('+(/^(true|false)$/.test(codeExpectTo)?codeExpectTo:'\''+eacapeStr(codeExpectTo)+'\'')+'));');
                                        break;
                                    case 'contain':
                                        arrCodes.push('       .should.contain(_(\''+eacapeStr(codeExpectTo)+'\'));');
                                        break;
                                    case 'above':
                                        arrCodes.push('       .should.above(_(\''+eacapeStr(codeExpectTo)+'\'));');
                                        break;
                                    case 'below':
                                        arrCodes.push('       .should.below(_(\''+eacapeStr(codeExpectTo)+'\'));');
                                        break;
                                    case 'match':
                                        arrCodes.push('       .should.match('+eacapeStr(codeExpectTo)+');');
                                        break;
                                    case 'notMatch':
                                        arrCodes.push('       .should.not.match('+eacapeStr(codeExpectTo)+');');
                                        break;
                                }
                        ...
                        case 'updateVar':
                            co(function*(){
                                ...
                                if(reDomRequire.test(updateType)){
                                    arrCodes.push('return driver.sleep(300).wait(\''+eacapeStr(updateParams[0])+'\', 30000)');
                                }
                                else{
                                    arrCodes.push('return driver');
                                }
                                switch(updateType){
                                    ...
                                    case 'text':
                                        ...
                                        break;
                                    case 'attr':
                                        arrCodes.push('       .attr(\''+eacapeStr(updateParams[1])+'\')');
                                        break;
                                    case 'css':
                                        arrCodes.push('       .css(\''+eacapeStr(updateParams[1])+'\')');
                                        break;
                                    case 'url':
                                        arrCodes.push('       .url()');
                                        break;
                                    case 'title':
                                        ...
                                        break;
                                    case 'cookie':
                                        arrCodes.push('       .cookie(\''+eacapeStr(updateParams[0])+'\')');
                                        break;
                                    case 'localStorage':
                                        arrCodes.push('       .localStorage(\''+eacapeStr(updateParams[0])+'\')');
                                        break;
                                    case 'sessionStorage':
                                        arrCodes.push('       .sessionStorage(\''+eacapeStr(updateParams[0])+'\')');
                                        break;
                                }
