    ...
    inquirer.prompt(questions).then(function (answers) {
        ...
        function onCommand(cmdInfo) {
            ...
            if (/^!/.test(cmdInfo.cmd)) {
                ...
                lastCmdInfo0 = cmdInfo;
            } else if (cmdInfo.cmd == 'dragend' && lastCmdInfo0.cmd == 'dragstart') {
                cmdInfo.data.x = cmdInfo.data.x - lastCmdInfo0.data.x;
                cmdInfo.data.y = cmdInfo.data.y - lastCmdInfo0.data.y;
                console.log({cmdInfo})
                cmdQueue.push(cmdInfo, 2);
                lastCmdInfo0 = cmdInfo;
            } else {
