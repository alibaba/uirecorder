    ...
    function getRelativeDomPath(rootNode, target, isAllDom) {
        ...
        try {
            ...
            if (IoTCustomized) {
                ...
                } else if (target.nodeName.toLowerCase() == 'div' && target.parentNode.nodeName.toLowerCase() == 'li') {
                    if (target.lastChild.nodeName.toLowerCase() == 'span') {
            ...
            if (IoTCustomized) {
                ...
                if (textValueIoT && !reTextValueBlack.test(textValueIoT) && textValueIoT.length <= 50 && checkUniqueXPath(rootNode, tempTextPathIoT, isAllDom)) {
                    // text定位
    ...
    function initRecorderDom() {
        ...
        function initToolsPannel() {
            ...
            function showExpectDailog(expectTarget, callback) {
                ...
                var domExpectDomDiv, domExpectParamDiv, domExpectSleep, domExpectType, domExpectDom, domExpectParam,
                    domExpectCompare, domExpectTo;
            ...
            function showVarsDailog(domInfo, callback) {
                ...
                var domVarsDomPath;
                var domVarsType, domVarsNameArea, domVarsName, domVarsTemplate, domVarsTemplateResult, domVarsAddName,
                    domVarsValue;
